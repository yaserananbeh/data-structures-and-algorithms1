...
const hasNumber = (string) => {
  // Solution code here...
  let regex=/[a-z]{1,}[0-9]{1,}/gi;
  let variable=(regex.test(string));
  return variable
};
...
const validatePhoneNumber = (phoneNumber) => {
  ...
  let variable=(pattern.test(phoneNumber));
  return variable
};
